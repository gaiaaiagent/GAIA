...
# Common environment variables for all agents (optimized for Claude 3.5 Haiku performance)
BASE_ENV="LOG_LEVEL=info TEXT_PROVIDER=anthropic TEXT_MODEL=claude-3-5-haiku-20241022 EMBEDDING_PROVIDER=openai EMBEDDING_MODEL=text-embedding-3-small POSTGRES_URL=postgresql://postgres:postgres@localhost:5433/eliza KNOWLEDGE_PATH=$KNOWLEDGE_PATH LOAD_DOCS_ON_STARTUP=false"
