...
export const listSellOrdersByBatchShape = {
...
export const listSellOrdersByBatchSchema = z.object({
...
// 3. Type for handler
export type ListSellOrdersByBatchParams = z.output<typeof listSellOrdersByBatchSchema>;

// 4. Pagination builder
function buildOffsetPageRequest(params: ListSellOrdersByBatchParams) {
...
// 5. Handler function
export async function listSellOrdersByBatch(params: ListSellOrdersByBatchParams) {
  try {
    ...
    const response = await rpcClient.regen.ecocredit.marketplace.v1.sellOrdersByBatch({
