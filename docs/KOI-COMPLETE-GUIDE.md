...
For complete installation and deployment instructions, see [KOI-PIPELINE-INTEGRATION.md](./KOI-PIPELINE-INTEGRATION.md).

Key installation components:
- Apache Jena Fuseki SPARQL database
- Django backend API
- KOI Query Server
- React frontend with KOI visualization
