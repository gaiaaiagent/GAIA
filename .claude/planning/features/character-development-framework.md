...
Our approach to character development goes beyond typical chatbot personas. We're creating living, breathing digital entities that embody regenerative principles and can evolve with their interactions.
...
4. **Growth Trajectory**: How they evolve over time

## Collaborative Development Approach

### Our Working Partnership

Creating authentic characters requires deep collaboration. Throughout our process, I'll be asking you numerous questions to understand:

- **Real Context**: The actual dynamics of the Regen Network x GAIA AI partnership
- **Authentic Voices**: How real team members communicate and think
- **Living Knowledge**: The evolving understanding within the community
- **Grounded Purpose**: The genuine needs these agents must address

### Materials That Bring Characters to Life
...
- **Living Documentation**: Resources that evolve with the project

This ensures our agents can always ground their responses in real sources and acknowledge the origins of their knowledge.
...
- **Relationship Building**: Show growing familiarity
...
"style": {
  "all": [
    ...
    "Relationship-building defaults"
  ],
  "chat": [
...
4. How do they handle failure or uncertainty?
...
4. How do they show care or concern?
...
4. What boundaries do they maintain?
5. How do they repair relationship damage?
...
## Next Steps for RegenAI Characters

1. **Workshop each character's core identity**
2. **Create detailed backstories**
3. **Develop unique voice samples**
4. **Map knowledge domains**
5. **Design inter-agent dynamics**
6. **Test through roleplay scenarios**
7. **Iterate based on interactions**
