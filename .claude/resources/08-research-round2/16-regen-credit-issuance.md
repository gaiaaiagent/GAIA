...
query FeePayments {
  allTransactions(
    condition: {type: "regen/MsgCreateClass"}
...
*Research completed July 15, 2025. For updates or corrections, consult the REGEN Network community forums or official documentation.*
