    ...
    const journey = [
      {
        ...
        score: '44%',
        grade: 'F',
        insight: 'Failing system, harsh scoring',
      },
      { stage: 'First Fix', score: '60%', grade: 'D', insight: 'Added critical relationships' },
      {
        stage: 'Code Enhancement',
        score: '67%',
        grade: 'D',
        insight: 'Improved technical accuracy',
      },
      {
        stage: 'Rebuilt Scoring',
        score: '72%',
        grade: 'C',
        insight: 'Fair assessment revealed truth',
      },
      {
        stage: 'Deep Enhancement',
        score: '75%',
        grade: 'C',
        insight: 'Added real developer insights',
      },
    ];
