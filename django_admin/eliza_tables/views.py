...
from .models import Agent, Memory, Room, CentralMessage, MessageServer
import json

class DashboardView(LoginRequiredMixin, TemplateView):
    template_name = 'eliza_tables/dashboard.html'
...
class InteractionReportView(LoginRequiredMixin, TemplateView):
    template_name = 'eliza_tables/interaction_report.html'
...
class AgentDetailView(LoginRequiredMixin, TemplateView):
    template_name = 'eliza_tables/agent_detail.html'
